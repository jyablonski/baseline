...
def test_query_builders() -> None:
    ...
    assert "player_season_stats.ppg" in player_season_stats_query(1)["dimensions"]
    ...
    query, applied = team_record_query("gsw", opponent_abbreviation="chi", location="Chicago")
